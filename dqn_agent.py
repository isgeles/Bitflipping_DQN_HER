...
class Agent:
    ...
    def __init__(self, state_size, action_size, batch_size, buffer_size, gamma, tau, lr):
        """Initialize an Agent
    ...
    def store_episode_HER(self, states, actions, rewards, next_states, dones, replay_strategy='final', k=4):
        ...
        @param next_states: list of next states (is stored as s'||g in memory)
        @param dones: list of dones (indicates end of episode)
